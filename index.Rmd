...
# # Identify top N songs with the highest valence for each month and year
# top_n_loudness_songs_by_year <- combined_data %>%
#   group_by(year, month) %>%
#   slice_max(order_by = loudness, n = 1) %>%
#   select(year, month, track.name, loudness)
# 
# # Display the top N songs with the highest valence from every month and year
# print(top_n_loudness_songs_by_year)
```
...
# # Identify top N songs with the highest valence for each month and year
# top_n_valence_songs_by_year <- combined_data %>%
#   group_by(year, month) %>%
#   slice_max(order_by = valence, n = 1) %>%
#   select(year, month, track.name, valence)
# 
# # Display the top N songs with the highest valence from every month and year
# print(top_n_valence_songs_by_year)
```
...
# # Identify top N songs with the highest valence for each month and year
# top_n_popularity_songs_by_year <- combined_data %>%
#   group_by(year, month) %>%
#   slice_max(order_by = track.popularity, n = 1) %>%
#   select(year, month, track.name, track.popularity)
# 
# # Display the top N songs with the highest valence from every month and year
# print(top_n_popularity_songs_by_year)
```
